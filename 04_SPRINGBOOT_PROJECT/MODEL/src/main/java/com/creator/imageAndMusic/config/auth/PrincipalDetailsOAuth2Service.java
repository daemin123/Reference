...
import com.creator.imageAndMusic.config.auth.provider.GoogleUserInfo;
import com.creator.imageAndMusic.config.auth.provider.KakaoUserInfo;
import com.creator.imageAndMusic.config.auth.provider.NaverUserInfo;
import com.creator.imageAndMusic.config.auth.provider.OAuth2UserInfo;
